...
export default function SearchingTheory() {
  ...
  return (
      ...
      <div className="bg-gradient-to-br mt-6 md:mt-10 bg-amber-100 from-slate-800 to-slate-900 p-2 sm:p-6 md:p-8 rounded-xl shadow-2xl border border-slate-700/50 backdrop-blur-sm">
