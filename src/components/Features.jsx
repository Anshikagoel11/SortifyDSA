...
import { FaCode, FaTools, FaMoon, FaLightbulb, FaBug } from "react-icons/fa";
  ...
  const features = [
    {
      ...
      description: "Step-by-step visualization with real-time code highlighting and execution tracking.",
      color: "blue"
    },
    {
      icon: <FaTools className="text-purple-400 text-xl" />,
      title: "Customizable Inputs",
      description: "Adjust array size, speed, and parameters to see different algorithm behaviors.",
      color: "purple"
    },
    
    {
      ...
      title: "Learning Mode",
      description: "Detailed explanations and tips at each step of the algorithm.",
      color: "amber"
    },
    {
  icon: <FaMoon className="text-indigo-400 text-xl" />,
  title: "Dark Mode Optimized",
  description: "Clean and visually optimized interface for long coding sessions, even in dark environments.",
  color: "indigo"
},
{
  icon: <FaBug className="text-rose-400 text-xl" />,
  title: "Step-by-Step Debugger",
  description: "Pause, resume, and inspect every step of the algorithm just like a real debugger.",
  color: "rose"
}
  ...
  return (
     <div className=" bg-[#0F172A] min-h-screen py-12 sm:py-16 px-8 sm:px-6 lg:px-8 ">
        ...
        >
          Detailed explanations and tips appear at each step to help you truly understand the logic.
        </motion.p>
