  ...
  return (
    <motion.button
      ...
      className={`
        ...
        ${isActive ? "border-blue-400/50" : "border-gray-600/30 hover:border-blue-400/30"}
      `}
    >
      {/* Background gradient */}
      <motion.div
      ...
      >
        ...
        >
          ...
          >
            ...
            />
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-500 absolute right-3 top-2.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            {filteredAlgorithms.length > 0 ? (
              filteredAlgorithms.map((item) => (
                <motion.div
                  ...
                  layout
                >
                  <Link to={`/sorting/${item.toLowerCase().replaceAll(" ", "-")}`}>
                    <AlgorithmButton 
                      item={item} 
